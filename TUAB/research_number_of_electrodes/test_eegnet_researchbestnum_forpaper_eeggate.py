...
【動的な電極選択 (Gate) だけ】を
research_number_of_electrode/loso_researchbestnum_paper2class_eeggate.py の設計に
差し替えてある。詳細は下の「★ Gate (動的な電極選択) の設計」を参照。
"""
...
# --- 自作モジュールのインポート ---
# cheat_sheet (gcn_select_net) は optuna trial 35 の構造で学習した
...
RESEARCH_BASE_DIR = '/mnt/data/toshiki.ohno/TUAB/research_number_of_electrode/results_forpaper_eeggate_2/'
...
# =========================================================================
# ★ Gate (動的な電極選択) の設計
#   loso_researchbestnum_paper2class_eeggate.py の改修をそのまま移植したもの。
#   ここ以外の処理は test_eegnet_researchbestnum_forpaper.py と同一。
#
...
if __name__ == '__main__':
    ...
    print(f"Number of classes (TUAB): {num_classes}")
