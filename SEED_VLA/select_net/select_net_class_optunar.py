...
class Config:
    def __init__(self):
        ...
        self.num_embedding = 32       # SEED-VLA
        self.num_labels = 3           # SEED-VLAは3クラス
...
class Embeddings(nn.Module):
    def __init__(self, config, gnn_heads=4, gnn_dropout=0.3):
        ...
        # カスタムDenseGATを使用
        self.gat3 = DenseGAT3(config.hidden_size, config.hidden_size, num_nodes=18, heads=gnn_heads, dropout=gnn_dropout)
...
class gcn_select_net(nn.Module):
    def __init__(self, num_classes=3, hidden_size=64, num_hidden_layers=4, 
        ...
        self.bm2d = nn.BatchNorm2d(cnn_hidden//2)
        ...
        self.bm2d2 = nn.BatchNorm2d(cnn_hidden//4)
...
if __name__ == '__main__':
    # SEED-VLA ダミーデータ: (Batch, Time, Freq, Channel) = (100, 16, 5, 18)
