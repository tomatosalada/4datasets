...
class gcn_select_net(nn.Module):
    def __init__(self, num_classes=6, hidden_size=64, num_hidden_layers=4, 
        ...
        self.bm2d = nn.BatchNorm2d(cnn_hidden//2, False)
        ...
        self.bm2d2 = nn.BatchNorm2d(cnn_hidden//4, False)
        self.global_pool2 = nn.AdaptiveAvgPool2d((2, 2))

        # TUEV用の16チャンネル完全結合グラフを作成
        self.graph_path = "/mnt/data/toshiki.ohno/TUEV_dataset/TU1v/TU1v/v2.0.1/GNN/graph_path/common_graph_edge_index_mi_0.2_50_tuev_all.pt"
